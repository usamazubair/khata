...
const TITLES: Record<CategoryType, string> = {
  expense: "New expense",
  saved: "Add to savings",
  budget: "New budget spend",
  fixed: "New entry",
};

/** The manual entry form, scoped to one category type at a time. Reached
 *  from the Add hub already knowing what kind of money this is, so there's
